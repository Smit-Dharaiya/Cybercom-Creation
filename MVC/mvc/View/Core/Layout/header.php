<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand mx-2" href="#" style="font-size: 40px ; font-feature-settings: 'smcp' on"><i class="fab fa-shopware fa-lg"></i><b> QuesteCom</b></a>
    ...
    <div class="collapse navbar-collapse flex-row-reverse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        ...
        <a class="nav-link float-end" href="<?php echo $this->getUrlObject()->getUrl('grid', 'configgroup'); ?>">Config Group</a>
        <a class="nav-link float-end" href="<?php echo $this->getUrlObject()->getUrl('grid', 'attribute'); ?>">Attribute</a>
        <a class="nav-link float-end" href="<?php echo $this->getUrlObject()->getUrl('grid', 'cart'); ?>">Cart</a>
